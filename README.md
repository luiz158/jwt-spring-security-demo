# HINT [![Build Status](https://travis-ci.org/coderspack/spring-boot-starter-jwt.svg?branch=master)](https://travis-ci.org/coderspack/spring-boot-starter-jwt)(https://travis-ci.org/larmic/jwt-spring-security-demo) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
